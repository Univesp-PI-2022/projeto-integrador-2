    ...
    <div class="container-fluid">
        <div class="row flex-nowrap">
            ...
            ?>
                ...
                <div class="container background-area-admin">
                    <!-- BLOG -->

                    <div class="container" id="blog-create-post" style="display:none ;">
                    ...
                    <div class="container " id="form-user-registration" style="display:none ;">
