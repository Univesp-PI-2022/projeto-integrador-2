            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="all-posts.php">Blog</a>
                        </li>
            ...
            <div id="carouselExampleIndicators" class="carousel slide sem_margem" data-bs-ride="carousel">
                ...
                <div class="carousel-inner sem_margem">
                    <div class="carousel-item active">
                        <img src="../public/images/Slide_1.png" class="d-block w-100  " alt="festa na praça solidaria" style="min-height: 40vw ;">
                    </div>
                    <div class="carousel-item">
                        <img src="../public/images/Slide_2.png" class="d-block w-100" alt="cachorro na coberta" style="min-height: 40vw ;">
                    </div>
                    <div class="carousel-item">
                        <img src="../public/images/Slide_3.png" class="d-block w-100" alt="foto de um pão caseiro" style="min-height: 40vw ;">
                    </div>
                </div>
